...
var Engine = (function (global) {
    ...
    function render() {
        ...
        for (row = 0; row < numRows; row++) {
            for (col = 0; col < numCols; col++) {
                 ...
                 */
                if (gameState.markTile[0] == col && gameState.markTile[1] == row) {
                    ctx.drawImage(Resources.get('images/water-block-marked.png'), col * 101, row * 83);
                } else {
    ...
    function renderEntities() {
        // rendering order changed from original so that player will be covered
        // by bug at game end!  -DN
        player.render();
     ...
     */
    // NOTE: I've used this function to handle the end of the game.  -DN
    function reset() {
        if (gameState.gameOver) {
